module github.com/am-sokolov/livekit-agent-sdk-go/examples/realtime-transcription-agent
...
require (
	github.com/am-sokolov/livekit-agent-sdk-go v0.0.0-00010101000000-000000000000
