...
func (suite *BroadcastStageTestSuite) TestAddBroadcastCallback() {
	...
	called := false
	callback := func(ctx context.Context, event TranscriptionEvent, metadata ParticipantMetadata, trackID string) error {
		called = true
		return nil
	}
...
func (suite *BroadcastStageTestSuite) TestProcessWithCompleteTranscriptionEvent() {
	...
	suite.stage.AddBroadcastCallback(func(ctx context.Context, event TranscriptionEvent, metadata ParticipantMetadata, trackID string) error {
		return nil
	})
